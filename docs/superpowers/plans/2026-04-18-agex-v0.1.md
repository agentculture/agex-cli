...
[project.urls]
Homepage = "https://agex.culture.dev"
Repository = "https://github.com/OriNachum/agex"
Issues = "https://github.com/OriNachum/agex/issues"
...
`agex` — non-agentic Python CLI that emits deterministic per-backend markdown briefings for autonomous agents. PyPI distribution: `agex-cli`. Spec: `docs/superpowers/specs/2026-04-18-agex-design.md`.
...
- **Install:** `uv tool install agex-cli` or `pipx install agex-cli`
...
> Cloudflare Pages project creation and custom-domain binding (`agex.culture.dev`) is a one-time manual step tracked as a GitHub issue.
...
9. Cloudflare Pages project creation + `agex.culture.dev` domain binding.
