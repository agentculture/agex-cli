...
name: cicd
description: >
  agex-cli's CI/CD lane: open PR (auto-wait for Qodo/Copilot), push fixes
  ...
  agex-cli, handling review feedback, polling CI status, or the user says
  "create PR", "review comments", "address feedback", "resolve threads".
  Vendored from steward 0.11.0 (identifier-only divergence); upstream
